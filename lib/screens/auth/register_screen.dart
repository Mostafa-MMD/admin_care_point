                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ReusableTextFormField(
                          ...
                          text: 'Last name',
                          prefix: const Icon(Icons.person_pin_rounded),
                          textInputType: TextInputType.text,
                          validator: (value) {
                            if (value!.isEmpty) {
                        ...
                        ReusableTextFormField(
                          controller:
                              classInstance.phoneNumberRegisterController,
                          text: 'Phone Number',
                        ...
                        ReusableTextFormField(
                          ...
                          text: 'Address',
                          prefix: const Icon(Icons.maps_home_work_outlined),
                          textInputType: TextInputType.text,
                          validator: (value) {
                            if (value!.isEmpty) {
                        ...
                        ReusableTextButton(
                          color: defBlue,
                          onPressed: () async {
                            if (classInstance.registerFormKey.currentState!
                                .validate()) {
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              "If you have an admin account, please",
                              style: TextStyle(
                                fontSize:
